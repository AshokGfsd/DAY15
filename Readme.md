...
- [_**HTML-FORM CSS**_](./Form/css/style.css)

- [_**HTML-FORM JS**_](./Form/js/script.js)
...
- [_**HTML-PAGINATION CSS**_](./pagination/css/style.css)

- [_**HTML-PAGINATION JS**_](./pagination/js/script.js)