...
let titlecontent = setTitle("form", "id", "survey-form");
...
let email_div = sixdiv("div", "form-group", "col-md-10");
...
let address_label = sixlabel("label", "for", "comments", "ADDRESS:");
...
let th9 = tableheader("th", "scope", "col", "EMAIL");
...
email_div.append(email_label, email_input);
...
function btnname() {
  ...
  var address_value = document.getElementById("comments").value;
